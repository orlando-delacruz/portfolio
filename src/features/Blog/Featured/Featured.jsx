...
import featured from "../../../data/pages/Blog/feature.data";
import * as S from "./Featured.styled";

/**
 * FeaturedArticle
 * Large horizontal card highlighting the latest/pinned blog post.
 * Left: thumbnail with overlay gradient. Right: badge, meta, title, description, CTA.
 */
const Featured = () => {
  const {
    badge,
