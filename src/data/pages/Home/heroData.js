...
const heroData = {
  ...
  subtitle:
    "I craft clean, responsive, and user-focused web interfaces with a passion for modern design and performance.",
  ...
  socialLinks: [
    {
      id: "github",
      icon: FaGithub,
      link: "https://github.com/orlando-delacruz",
      label: "Visit my Github",
    },
    {
      id: "linkedin",
      icon: FaLinkedin,
      link: "https://www.linkedin.com/in/orlando-jr-dela-cruz-127998273/",
    ...
    },
    {
      id: "gmail",
      icon: IoMail,
      link: "mailto:orlando.delacruz.dev@gmail.com",
  ...
  skills: [
    ...
    // Replaced Laravel with JavaScript
    {
      id: 2,
      icon: SiJavascript,
      color: "#F7DF1E",
